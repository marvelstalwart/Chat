...
{/*           
          <img src={chat} className="max-h-56"></img> */}
          </div>
        <div className='h-full flex'>
           ...
           <div className=' absolute blur-3xl  w-full justify-center -z-10 flex  gap-2'>
            <div className='h-20 bg-blue w-48 animate-bounce'></div>
        ...
        <div className='flex flex-col justify-center gap-2 h-60  bg-white  p-3 px-4 shadow-md rounded-md rounded-t-2xl'>
              <Formik
              initialValues={{
                email: "",
                password: ""
            ...
            <input   onChange={handleChange} onBlur={handleBlur} autoComplete="off" className="w-full  outline-0 border-b-2 px-5 py-2 autofill:bg-transparent" type="password" name="password" placeholder="Password"/>
            </div>
            <div className='text-red-500 text-[10px]'>
                ...
                <div className="w-full pt-2 flex justify-center"><button  className='w-fit p-1 rounded-md px-2 font-medium cursor-pointer bg-blue text-white ' type='submit' name='submit' value="submit">{isLoading?    <svg className="inline mr-2 w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-gray-600 dark:fill-gray-300" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className='flex text-sm justify-center gap-2'> <div>Create an account</div> <Link to="/register"><div className='font-bold text-blue'>Here</div></Link></div>  
